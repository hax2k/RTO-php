 <?php 
        ...
        if(count($_POST)>0)
        {
          ...
          $q = "INSERT INTO city (city_state_id,city_name) values ('$state_id','$city_name')";
              ...
              <form role="form" method="post" id="myform">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  id="exampleInputName" placeholder="Enter State Name" class="form-control" name="city_name">
                  </div>
