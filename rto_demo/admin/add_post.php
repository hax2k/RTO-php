 <?php 
        ...
        if(count($_POST)>0)
        {
          ...
          $subcategory_id = $_POST['post_subcategory_id'];
          ...
          foreach ($_FILES['post_image'] as $key => $value) {
            if($key == "name")
            {
                foreach ($value as $k => $v) 
                {
                 ...
                 // die;
                  $image = time()."_".$v;
                  $m = "INSERT INTO post_image (post_id,post_image_path) VALUES('$id','$image')";
                  $m = mysqli_query($con,$m);
                  move_uploaded_file($_FILES['post_image']['tmp_name'][$k], "images/$image");
                }
            }
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="form-group">
                  <label for="exampleInputName">Post Image</label><br>
