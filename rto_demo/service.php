...
<div class="col-6 mt-5">
  ...
  <div class="card">
    ...
    <div class="card-body d-flex">
        <img src="img/blog/author.png" class="card-img-top mt-3 mb-3 ml-3" style="max-width: 100px;" alt="img">

        <span class="ml-5">UNION OF INDIA <br>
              GUJARAT STATE</span>
        <span class="ml-5"><b>Driving Licence</b></span>
    </div>

    <div class="card-body d-flex">

        <p class="card-text mr-1">Date of First Issue : <b>04-09-2018</b></p>
        <p class="card-text ml-5">Validity : <b>03-09-2038</b></p>
     
    </div>

    <div class="card-body d-flex">

      <p class="card-text mr-5">Date of Birth : <b>17-02-2000</b></p> 
      <p class="card-text ml-5">Blood Group : <b>B+ VE</b></p>

    </div>

    <div class="card-body">
        <span>Name </span>
        <h4>Charles L. Wier</h4>
    </div>
...
<div class="col-6 mt-5">
  ...
  <div class="card">
    ...
    <div class="card-body d-flex">
        ...
        <span class="ml-5">GJ05 313-389-8592 <br></span>
        <span class="ml-5"><b>Aadhar No. : </b>367-76-XXXX</span>
    </div>

    <div class="card-body d-flex">

        <p class="card-text mr-1">LMV <br><b>04-09-2018</b></p>
        <p class="card-text ml-5">MCWG <br><b>04-09-2018</b></p>
    ...
    <div class="card-body">
        ...
        <h4>3142 Prudence Street <br>
            Lincoln Park, MI 48146 <br></h4>
    </div>
