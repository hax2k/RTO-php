...
$publishable_key 	= "pk_test_Up5wSREW87DcHJWG7I2TZUGc00HjokYyu5";
$secret_key			= "sk_test_HpgdCbMlA9d6h5paGnY0brp600MXUOwlY4";
...
if(isset($_POST['stripeToken'])){
	...
	try {
		...
		if(count($_POST)>0 && $result == "succeeded")
	{
		...
		if(!empty($n))
		{
					$q = "INSERT INTO payment (user_id,slot_register_id,pay_charge,card_no,cvv,exp_month,exp_year) VALUES ('".$_SESSION['id']."','$id','$p','$n','$c','$m','$y')";
					...
					if($q1)
					{
						...
						{
								header("location:rcbook.php?book_id=".$id );
						}
						else if($p2['category_name'] == "Vehical")
						{
...
<!-- Bootstrap -->
<link rel="stylesheet" href="s_detail/css/bootstrap.min.css">
<!-- Responsive styles-->
<link rel="stylesheet" href="s_detail/css/demo-style.css"> 
<!-- Font awosome -->
<link rel="stylesheet" href="s_detail/css/font-awesome.min.css">  
                              ...
                              <form action="" method="post" name="cardpayment" id="payment-form">
                                ...
                                <div class="button-style">
                                    <button class="button login submit">
                                       Paynow ($50.00) <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                    </button>
                                </div>
...
<script src="s_detail/js/main.js"></script>
